...
class SARIMARegression():
    ...
    def __init__(self, p_d_q_order=(0,0,0), P_D_Q_order=(0,0,0,4)):
        '''
        Instantiates a new SARIMARegression object. 

        Keyword arguments:
        p_d_q_order -- tuple: the order of the regression of the form (p, d, q), default (0,0,0)
            Requires p,d, and q to be >=0.
        P_D_Q_order -- tuple: the order of the regression of the form (P, D, Q, m), default (0,0,0,4)
        ...
        # TODO future just create model here, switch to pmdarima
        # TODO very unsafe using array of len 100 just for testing
...
class AutoARIMARegression(SARIMARegression):
    '''
    Represents a SARIMA time series regression with automatic order detection.
    ...
    - No mutator methods
    - TODO protection by property
    '''
    def __init__(self, p_d_q_order = None, P_D_Q_order = None):
        '''
...
class BruteForceARIMARegression(SARIMARegression):
    '''
    Represents a SARIMA time series regression with brute force order detection.
